...
#ifndef P11BCONNECTION_H_
#define P11BCONNECTION_H_
...
class P11BConnection : public DuplexConnection
{
...
public:
	...
	P11BConnection(SpikingGroup * source, NeuronGroup * destination, TransmitterType transmitter=GLUT);

	P11BConnection(SpikingGroup * source, NeuronGroup * destination, 
			const char * filename, 
			AurynFloat eta=1, 
