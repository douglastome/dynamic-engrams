...
#ifndef GLOBALPF2BCONNECTION_H_
#define GLOBALPF2BCONNECTION_H_
...
class GlobalPF2BConnection : public DuplexConnection
{
...
public:
	...
	GlobalPF2BConnection(SpikingGroup * source, NeuronGroup * destination, 
	...
	GlobalPF2BConnection(SpikingGroup * source, NeuronGroup * destination, 
			...
			AurynFloat kappa=3., AurynFloat maxweight=1. , 
			TransmitterType transmitter=GLUT,
			string name = "GlobalPF2BConnection" );

	virtual ~GlobalPF2BConnection();
